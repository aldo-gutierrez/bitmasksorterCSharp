...
Console.WriteLine("AVG<float>  RadixBitSorterGenericLong time: {0} ms", totalRadix2 / iterations);
Console.ReadKey();
...
Console.WriteLine("AVG<double>  RadixBitSorterGenericLong time: {0} ms", totalRadix2 / iterations);
Console.ReadKey();