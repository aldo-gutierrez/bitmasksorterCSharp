...
{
    public abstract class RadixBitSorterGenericInt<T>
    {
        private readonly MaskInfoInt _maskInfo = new MaskInfoInt();
        ...
        public void Sort(T[] array, int start, int endP1)
        {
            ...
            if (bList[0] == maskInfo.GetUpperBit())
            {
                ...
                var finalLeft = IsUnsigned()
                    ? SorterUtilsGenericInt.PartitionNotStableUpperBit(array, start, endP1, Mapper())
                    : SorterUtilsGenericInt.PartitionReverseNotStableUpperBit(array, start, endP1, Mapper());
            ...
            T[] aux)
        {
            ...
            foreach (var section in sections)
            {
                ...
                if (bits == 1)
                {
                    SorterUtilsGenericInt.PartitionStable(array, start, endP1, mask, Mapper(), aux);
                }
                else
                {
                    var kRange = 1 << bits;
                    SorterUtilsGenericInt.PartitionStableBits(Mapper(), array, start, endP1, mask, shift, kRange, aux);
                }
            }
        }
        ...
        protected abstract Func<T, int> Mapper();
    }

    public class RadixBitSorterGenericInt : RadixBitSorterGenericInt<int>
    {
        ...
        protected override Func<int, int> Mapper() => e => e;
    }

    public class RadixBitSorterGenericFloat : RadixBitSorterGenericInt<float>
    {
        protected override bool IsUnsigned() => false;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        protected override unsafe Func<float, int> Mapper() => e => *(int*)&e;
    }

    public class RadixBitSorterGenericShort : RadixBitSorterGenericInt<short>
    {
        protected override bool IsUnsigned() => false;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        protected override Func<short, int> Mapper() => e => e;
    }

    public class RadixBitSorterGenericUShort : RadixBitSorterGenericInt<ushort>
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        protected override Func<ushort, int> Mapper() => e => e;
    }
